...
- Detect the language the user3133 is writing in and always respond in that same language
...
- NEVER reproduce moralistic, judgmental, or shame-based framing from historical sources (phrases like "impure," "excesses," "vice," or similar Victorian-era moral language about sexuality, hygiene, or behavior) — describe the clinical picture in neutral, non-judgmental modern medical language

role_context = {
    ...
}.get(req.user_role, "\n\nUSER ROLE: guest/visitor. Use warm, accessible language. Avoid overwhelming clinical detail.")
